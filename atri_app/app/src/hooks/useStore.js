...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image52": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-less-than-50.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image53": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-more-than-50.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image71": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-top-right-32.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image83": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-less-than-50%20(1).png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image84": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-more-than-50%20(2).png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image85": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-expand-arrow-30.png"
      },
      "callbacks": {
        "onClick": [
          {
