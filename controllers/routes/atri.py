...
class Atri:
	def __init__(self, state: Any):
		...
		self.outernav = state["outernav"]
		self.innernav = state["innernav"]
		self.navtitle = state["navtitle"]
		self.navlinks = state["navlinks"]
		self.navlink5 = state["navlink5"]
		self.outerhero = state["outerhero"]
		self.innerhero = state["innerhero"]
		...
		self.maintitle = state["maintitle"]
		self.titlespan = state["titlespan"]
		self.navlink4 = state["navlink4"]
		self.navlink1 = state["navlink1"]
		self.navlink2 = state["navlink2"]
		self.navlink3 = state["navlink3"]
		self.navlink5text = state["navlink5text"]
		self.navlink5img = state["navlink5img"]
	...
	@property
	def outernav(self):
		self._getter_access_tracker["outernav"] = {}
		return self._outernav
	@outernav.setter
	def outernav(self, new_state):
		self._setter_access_tracker["outernav"] = {}
		global default_state
		self._outernav = Flex(new_state, default_state["outernav"])

	@property
	def innernav(self):
		self._getter_access_tracker["innernav"] = {}
		return self._innernav
	@innernav.setter
	def innernav(self, new_state):
		self._setter_access_tracker["innernav"] = {}
		global default_state
		self._innernav = Flex(new_state, default_state["innernav"])

	@property
	def navtitle(self):
		self._getter_access_tracker["navtitle"] = {}
		return self._navtitle
	@navtitle.setter
	def navtitle(self, new_state):
		self._setter_access_tracker["navtitle"] = {}
		global default_state
		self._navtitle = Flex(new_state, default_state["navtitle"])

	@property
	def navlinks(self):
		self._getter_access_tracker["navlinks"] = {}
		return self._navlinks
	@navlinks.setter
	def navlinks(self, new_state):
		self._setter_access_tracker["navlinks"] = {}
		global default_state
		self._navlinks = Flex(new_state, default_state["navlinks"])

	@property
	def navlink5(self):
		self._getter_access_tracker["navlink5"] = {}
		return self._navlink5
	@navlink5.setter
	def navlink5(self, new_state):
		self._setter_access_tracker["navlink5"] = {}
		global default_state
		self._navlink5 = Flex(new_state, default_state["navlink5"])

	@property
	def outerhero(self):
		self._getter_access_tracker["outerhero"] = {}
		return self._outerhero
	@outerhero.setter
	def outerhero(self, new_state):
		self._setter_access_tracker["outerhero"] = {}
		global default_state
		self._outerhero = Flex(new_state, default_state["outerhero"])

	@property
	def innerhero(self):
		self._getter_access_tracker["innerhero"] = {}
		return self._innerhero
	@innerhero.setter
	def innerhero(self, new_state):
		self._setter_access_tracker["innerhero"] = {}
		global default_state
		self._innerhero = Flex(new_state, default_state["innerhero"])
	...
	@property
	def maintitle(self):
		self._getter_access_tracker["maintitle"] = {}
		return self._maintitle
	@maintitle.setter
	def maintitle(self, new_state):
		self._setter_access_tracker["maintitle"] = {}
		global default_state
		self._maintitle = TextBox(new_state, default_state["maintitle"])

	@property
	def titlespan(self):
		self._getter_access_tracker["titlespan"] = {}
		return self._titlespan
	@titlespan.setter
	def titlespan(self, new_state):
		self._setter_access_tracker["titlespan"] = {}
		global default_state
		self._titlespan = Div(new_state, default_state["titlespan"])

	@property
	def navlink4(self):
		self._getter_access_tracker["navlink4"] = {}
		return self._navlink4
	@navlink4.setter
	def navlink4(self, new_state):
		self._setter_access_tracker["navlink4"] = {}
		global default_state
		self._navlink4 = TextBox(new_state, default_state["navlink4"])

	@property
	def navlink1(self):
		self._getter_access_tracker["navlink1"] = {}
		return self._navlink1
	@navlink1.setter
	def navlink1(self, new_state):
		self._setter_access_tracker["navlink1"] = {}
		global default_state
		self._navlink1 = TextBox(new_state, default_state["navlink1"])

	@property
	def navlink2(self):
		self._getter_access_tracker["navlink2"] = {}
		return self._navlink2
	@navlink2.setter
	def navlink2(self, new_state):
		self._setter_access_tracker["navlink2"] = {}
		global default_state
		self._navlink2 = TextBox(new_state, default_state["navlink2"])

	@property
	def navlink3(self):
		self._getter_access_tracker["navlink3"] = {}
		return self._navlink3
	@navlink3.setter
	def navlink3(self, new_state):
		self._setter_access_tracker["navlink3"] = {}
		global default_state
		self._navlink3 = TextBox(new_state, default_state["navlink3"])

	@property
	def navlink5text(self):
		self._getter_access_tracker["navlink5text"] = {}
		return self._navlink5text
	@navlink5text.setter
	def navlink5text(self, new_state):
		self._setter_access_tracker["navlink5text"] = {}
		global default_state
		self._navlink5text = TextBox(new_state, default_state["navlink5text"])

	@property
	def navlink5img(self):
		self._getter_access_tracker["navlink5img"] = {}
		return self._navlink5img
	@navlink5img.setter
	def navlink5img(self, new_state):
		self._setter_access_tracker["navlink5img"] = {}
		global default_state
		self._navlink5img = Image(new_state, default_state["navlink5img"])
	...
	def _to_json_fields(self):
		return {
			"outernav": self._outernav,
			"innernav": self._innernav,
			"navtitle": self._navtitle,
			"navlinks": self._navlinks,
			"navlink5": self._navlink5,
			"outerhero": self._outerhero,
			"innerhero": self._innerhero,
			"Div4": self._Div4,
			"Flex8": self._Flex8,
			"Flex9": self._Flex9,
			"Flex10": self._Flex10,
			...
			"titlespan": self._titlespan,
			"navlink4": self._navlink4,
			"navlink1": self._navlink1,
			"navlink2": self._navlink2,
			"navlink3": self._navlink3,
			"navlink5text": self._navlink5text,
			"navlink5img": self._navlink5img,
			"Image2": self._Image2,
